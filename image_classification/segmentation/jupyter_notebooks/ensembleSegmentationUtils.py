...
def getCoutoutFromCoords(poly_coords, image):
    x_min = int(max(min(poly_coords[0][0],poly_coords[1][0],poly_coords[2][0],poly_coords[3][0]),0))
    x_max = int(max(poly_coords[0][0],poly_coords[1][0],poly_coords[2][0],poly_coords[3][0],0))
    y_min = int(max(min(poly_coords[0][1],poly_coords[1][1],poly_coords[2][1],poly_coords[3][1]),0))
    y_max = int(max(poly_coords[0][1],poly_coords[1][1],poly_coords[2][1],poly_coords[3][1],0))
